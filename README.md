...
- **Web: [gsheps.social](https://gsheps.social)**
- ~**iOS: [App Store]()**~ WIP
...
gsheps.social deployments.
For deer, the intended deployment is with a websever than can serve static files, and reroute to `index.html` as needed. Today [gsheps.social](https://gsheps.social) is hosted on [cloudflare pages](https://pages.cloudflare.com/).
...
> gsheps.social is a community fork, and we'd love to merge your PR!

As a rule of thumb, the best features for gsheps.social are ones that have a disproportionately positive impact on the user experience compared to the matinance overhead.
Unlike some open source projects, since gsheps.social is a soft fork, any features (patches) we add on top of upstream social-app need to be maintained. For example,
...
- Change all branding in the repository and UI to clearly differentiate from gsheps.social.
...
Self hosting is great! It is our intention that gsheps.social is easy to self host and build on your own. If you host your own instance of gsheps.social, or make your own builds, please
...
If the issue pertains to infastructure, code, or systems outside the scope of gsheps.social, please refer to the
