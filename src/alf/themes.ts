...
export function createThemes({
  ...
  const color = {
    ...
    primary_25: `hsl(228, 33.30%, 97.10%)`,
    primary_50: `hsl(233, 30.80%, 94.90%)`,
    primary_100: `hsl(236, 29.40%, 90.00%)`,
    primary_200: `hsl(231, 31.40%, 80.00%)`,
    primary_300: `hsl(229, 34.60%, 70.00%)`,
    primary_400: `hsl(231, 34.90%, 57.80%)`,
    primary_500: `hsl(236, 34.80%, 45.10%)`,
    primary_600: `hsl(241, 38.10%, 38.00%)`,
    primary_700: `hsl(231, 39.90%, 32.00%)`,
    primary_800: `hsl(234, 42.20%, 25.10%)`,
    primary_900: `hsl(241, 45.70%, 18.00%)`,
    primary_950: `hsl(228, 49.00%, 10.00%)`,
    primary_975: `hsl(237, 50.00%, 7.10%)`,
